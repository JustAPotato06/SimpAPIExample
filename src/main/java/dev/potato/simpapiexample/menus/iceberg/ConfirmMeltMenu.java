...
public class ConfirmMeltMenu extends Menu {
    ...
    public ConfirmMeltMenu(PlayerMenuUtility playerMenuUtility) {
        ...
        playerToFreeze = playerMenuUtility.getData(PMUDataIceberg.PLAYER_TO_MELT, Player.class);
    }

    @Override
    public String getMenuName() {
        return "Confirm Melt: " + playerToFreeze.getDisplayName();
    }
    ...
    public void handleMenu(InventoryClickEvent e) throws MenuManagerNotSetupException, MenuManagerException {
        switch (e.getCurrentItem().getType()) {
            case LIME_CONCRETE:
                ...
                playerMenuUtility.getOwner().sendMessage(ChatColor.GREEN + "[SIMP API EXAMPLE] " + playerToFreeze.getDisplayName() + " has been melted successfully!");
                break;
            case RED_CONCRETE:
